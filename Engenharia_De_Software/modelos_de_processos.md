...
#### Modelo em cascata 
&emsp;O modelo em cascata ou waterfall, representa um detalhamento de suas atividades em um processo linear onde para avançar em um processo é necessário concluir o atual, esse processo é útil em casos que os requisitos do sistema são muito bem definidos e com poucas mudanças, já que após um processo ser concluído ele fica para trás até o reinício do cliclo.
